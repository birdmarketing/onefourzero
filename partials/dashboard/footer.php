...
<div id="newForm" name="newForm" class="form">
    ...
    <div class="form-content" id="form-content">
        <div class="form-close"><h6>New Project Request<h6><span class="form-close-button" id="form-close-button">&times;</span></div>
            ...
            <div class="brand-details2-labels2">
                <label for="brand-include">Include keywords:<div class="bubblePosition hoverBubble">
                        <p>Please enter any unique keywords for the brand that you would like to include in your search i.e. unique product names that are used without the company name<br /><br />e.g. "AirForce" for Nike
                            <br />For best results please do not enter generic industry keywords.</p>
...
<div id="MAForm" name="MAForm" class="form">
    ...
    <!-- M&A Form -->
    <div class="form-content" id="form-content">
        <div class="form-close"><h6>M&A Report Request<h6><span class="form-close-button2" id="form-close-button">&times;</span></div>
        <div class="form-project" id="form-project">
            ...
            <div class="project-details">
                <select id="ma-project-select" name="project-select" required />
            ...
            <div class="project-details2">
                <select id="ma-report-type" name="report-type" required />
        ...
        <div>
            ...
            <textarea id="ma-comments" class="form-comments" cols="40" rows="5"></textarea>
        </div>
        <div class="form-submit">
            <button class="btn-submit2" id="btn-submit" onclick="MASubmit(); Submit(); ">Submit</button>
        </div>
    </div>
...
<div id="VCForm" name="VCForm" class="form">
    ...
    <!-- VC Form -->
    <div class="form-content" id="form-content">
        <div class="form-close"><h6>Value Creation Report Request<h6><span class="form-close-button2" id="form-close-button">&times;</span></div>
        <div class="form-project" id="form-project">
            ...
            <div class="project-details">
                <select id="vc-project-select" name="project-select" required />
                <option value="project1">Project 1</option>
                <option value="project2">Project 2</option>
                <option value="project3">Project 3</option>
                <option value="otherproject">Other</option>
            ...
            <div class="project-details2">
                <select id="vc-report-type" name="report-type" required />
        ...
        <div>
            <label for="project-name">Other comments:</label>
            <textarea id="vc-comments" class="form-comments" cols="40" rows="5"></textarea>
        </div>
        <div class="form-submit">
            <button class="btn-submit2" id="btn-submit" onclick="VCSubmit(); Submit(); ">Submit</button>
        </div>
    </div>
...
<div id="successForm" class="form-success">
    ...
    <!-- Success Modal on form or report request submission-->
    <div class="success-content">
        <div class="success-close"><span class="close">&times;</span></div>
        <div class="success-text">Your request has been submitted!</div>
    </div>
...
<div id="successForm" class="form-success">
    ...
    <!-- ??????????????? whats the difference from the one above?-->
    <div class="success-content">
...
<div id="Originations" name="Originations" class="form">
    ...
    <div class="form-content2" id="form-content">
        ...
        <div><h3 style="color: white;">Originations</h3></div>
        <div class="padding">
...
<div id="FMForm" name="FMForm" class="form">
    ...
    <div class="form-content2" id="form-content">
        ...
        <div class="form-close" style="border-bottom: 0px"><span class="form-close-button2" id="form-close-button" style="color: white;">&times;</span></div>
        <div><h3 style="color: white;">Future Modelling</h3></div>
...
<div id="pricing-packages" name="pricing-packages" class="form">
    <div class="form-content" id="form-content">
        ...
        <div class="pricing-grid">
            ...
            <div class="cell"><h6> </h6></div>
            <div class="cell"><img class="img-responsive pricingimage" src="https://360creatives.blob.core.windows.net/creatives/check_premium.png"/></div>
            <div class="cell2"><h6> </h6></div>
            <div class="cell2"><h4>&bull; Benchmarking and<br />Reporting Tool<br />&bull; Data mirrors Market Map<br /><b>from $5,000/month</b></h4></div>
            <div class="cell2"><h4>&bull; Six modules<br />&bull; Multiple datasets<br />&bull; Fully self-managed<br /><b>from $10,000/month</b></h4></div>
            <div class="cell2"><h4>Standard features plus:<br />&bull; Forecasting Module<br />&bull; Custom enhancements<br /><b>from $20,000/month</b></h4></div>
        </div>
    </div>
</div>
...
<div id="glossary" name="glossary" class="form">
    ...
    <div class="form-content2" id="form-content">
        ...
        <div class="form-close" style="border-bottom: 0px"><span class="form-close-button2" id="form-close-button" style="color: white;">&times;</span></div>
        <div><h3 style="color: white;">Glossary</h3></div>

        <div class="padding">
            <div class="wrap-1">
                <input style="opacity: 0; margin:0px;" type="checkbox" id="tab-1" name="tabs" class="tab">
                <label class="glossary-label" for="tab-1"><div>Market Share and Demand</div><div class="cross"></div></label>
                <div class="questions">
                    <div class="question-wrap">
                        <input style="opacity: 0;" type="checkbox" id="question-1" name="question" class="question">
                        <label class="glossary-label" for="question-1"><div>TAM</div> <div class="cross"></div></label>
                        <div class="content">
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-2"><div>Headroom</div> <div class="cross"></div></label>
                        <div class="content">
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-3"><div>Share</div> <div class="cross"></div></label>
                        <div class="content">
            ...
            <div class="wrap-2">
                ...
                <label class="glossary-label" for="tab-2"><div>Sales and Marketing Performance</div><div class="cross"></div></label>
                <div class="questions">
                    <div class="question-wrap">
                        <input style="opacity: 0;" type="checkbox" id="question-5" name="question" class="question">
                        <label class="glossary-label" for="question-5"><div>Channels</div> <div class="cross"></div></label>
                        <div class="content">
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-6"><div>SEO</div> <div class="cross"></div></label>
                        <div class="content">
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-7"><div>PPC</div> <div class="cross"></div></label>
                        <div class="content">
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-8"><div>Social</div> <div class="cross"></div></label>
                        <div class="content">
            ...
            <div class="wrap-3">
                ...
                <label class="glossary-label" for="tab-3"><div>Customer Cohorts and Loyalty</div><div class="cross"></div></label>
                <div class="questions">
                    <div class="question-wrap">
                        <input style="opacity: 0;" type="checkbox" id="question-9" name="question" class="question">
                        <label class="glossary-label" for="question-9"><div>Cohorts</div> <div class="cross"></div></label>
                        <div class="content">
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-10"><div>Sentiment and Mentions</div> <div class="cross"></div></label>
                        <div class="content">
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-11"><div>Profiling</div> <div class="cross"></div></label>
                        <div class="content">
            ...
            <div class="wrap-4">
                ...
                <label class="glossary-label" for="tab-4"><div>Commercial Performance</div><div class="cross"></div></label>
                <div class="questions">
                    <div class="question-wrap">
                        <input style="opacity: 0;" type="checkbox" id="question-41" name="question" class="question">
                        <label class="glossary-label" for="question-41"><div>Commercial Benchmarking</div> <div class="cross"></div></label>
                        <div class="content">
                            In the Channels Tab, you can discover the leading marketing channels generating traffic for your target asset and each of your chosen competitor set. In the tab you can see: <br />
                            <br />
                            <b>Direct</b> - Traffic from users directly entering the URL, using a bookmark or saved link, etc. Direct traffic can be used as a barometer for brand strength (awareness and demand). <br />
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-42"><div>CAGR</div> <div class="cross"></div></label>
                        <div class="content">
                            SEO: Search Engine Optimization. This section looks at how findable, relevant and popular the website is in user search queries and how search engines rank them. <br />
                            <br />
                            <b>Top Traffic Originating Keywords</b>  - Keywords driving the largest amount of traffic to the website in relation to their search volume. <br />
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-43"><div>Year on Year</div> <div class="cross"></div></label>
                        <div class="content">
                            <b>CPC</b> - Cost Per Click. Paid advertising through channels such as Google Ads charged based on number of clicks that the ads get.<br />
                            <br />
                            <b>Paid Search Traffic</b> - Traffic from paid promotions or advertisements i.e. Google Ads. <br />
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-44"><div>Absolutes</div> <div class="cross"></div></label>
                        <div class="content">
                            ‘Social’ Tab investigates traffic coming from Referral and Social channels. <br />
                            <br />
                            <b>Referral</b> - Traffic directed to the website through another source (i.e. not a search engine) <br />
            ...
            <div class="wrap-5">
                ...
                <label class="glossary-label" for="tab-5"><div>Platform Engagement</div><div class="cross"></div></label>
                <div class="questions">
                    <div class="question-wrap">
                        <input style="opacity: 0;" type="checkbox" id="question-51" name="question" class="question">
                        <label class="glossary-label" for="question-51"><div>Web</div> <div class="cross"></div></label>
                        <div class="content">
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-52"><div>App</div> <div class="cross"></div></label>
                        <div class="content">
                    ...
                    <div class="question-wrap">
                        ...
                        <label class="glossary-label" for="question-53"><div>Web Performance</div> <div class="cross"></div></label>
                        <div class="content">
            ...
            <div class="wrap-7">
                ...
                <label class="glossary-label" for="tab-7"><div>Data Limitations</div><div class="cross"></div></label>
                <div class="questions">
                    <div class="question-wrap">
                        <input style="opacity: 0;" type="checkbox" id="question-7-1" name="question" class="question">
                        <label class="glossary-label" for="question-7-1"><div>Channels</div> <div class="cross"></div></label>
                        <div class="content">
                            In the Channels Tab, you can discover the leading marketing channels generating traffic for your target asset and each of your chosen competitor set. In the tab you can see: <br />
                            <br />
                            <b>Direct</b> - Traffic from users directly entering the URL, using a bookmark or saved link, etc. Direct traffic can be used as a barometer for brand strength (awareness and demand). <br />
...
<div id="faq" name="faq" class="form">
    ...
    <div class="form-content2" id="form-content">
        ...
        <div class="form-close" style="border-bottom: 0px"><span class="form-close-button2" id="form-close-button" style="color: white;">&times;</span></div>
        <div><h3 style="color: white;">FAQ</h3></div>
        &nbsp;
        <div class="wrap-1">
            <input style="opacity: 0; margin:0px;" type="checkbox" id="faq-1" name="tabs" class="tab">
            <label class="glossary-label" for="faq-1"><div>How do I change my subscription level?</div><div class="cross"></div></label>
            <div class="questions">
                <div class="question-wrap">
        ...
        <div class="wrap-2">
            ...
            <label class="glossary-label" for="faq-2"><div>How soon can I expect to see my new project on the dashboard?</div><div class="cross"></div></label>
            <div class="questions">
                <div class="question-wrap">
                    <div class="faqcontent">
        ...
        <div class="wrap-3">
            ...
            <label class="glossary-label" for="faq-3"><div>How long is the turn around for the M&A and Value Creation reports?</div><div class="cross"></div></label>
            <div class="questions">
                <div class="question-wrap">
                    <div class="faqcontent">
...
<!--begin::OG Js -->
<script type="text/javascript" src="/assets/js/og/dashboard-footer-script.js"></script>
<!--end::OG Js -->
